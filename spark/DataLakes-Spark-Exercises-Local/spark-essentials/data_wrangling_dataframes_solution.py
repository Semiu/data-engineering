...
# 3) read in the data set located at the path
logs_df = spark.read.json("C:/Users/Admin/Documents/data-engineering/spark/DataLakes-Spark-Exercises/spark-essentials/data/sparkify_log_small.json")
